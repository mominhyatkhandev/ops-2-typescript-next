...
const Footer = () => {
  return (
    <footer className="flex w-full flex-col items-center justify-center gap-[60px] px-[150px] pb-[60px]">
      ...
      <div className="flex w-full items-start justify-between gap-[499px]">
        <div className="flex flex-col items-start gap-[60px]">
          ...
          <div
            id="Copyright"
            className="text-base font-normal leading-tight text-secondary-600"
          >
